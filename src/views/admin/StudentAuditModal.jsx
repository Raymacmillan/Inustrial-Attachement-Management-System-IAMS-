...
// ── Document card ─────────────────────────────────────────────────────
function DocCard({ label, url, type }) {
  return (
    <div
    ...
    >
      <div className="flex items-center gap-3">
        <div
          className={`p-2 rounded-lg ${url ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-300"}`}
        >
          <FileText size={18} />
        </div>
        <div>
  ...
  return (
    <div className="fixed inset-0 z-[150] flex flex-col bg-gray-50 animate-in slide-in-from-bottom duration-300">
        ...
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <div className="flex justify-center mt-1">
                {/* Visual indicator using DB strings */}
          ...
          <Section title="Documents" icon={FileText} defaultOpen={true}>
            <div className="space-y-3">
              <DocCard label="Curriculum Vitae" url={student.cv_url} type="CV" />
              <DocCard label="Academic Transcript" url={student.transcript_url} type="Transcript" />
            </div>
          </Section>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    ...
                    className="shrink-0"
                  >
                    {saved ? <span className="flex items-center gap-1"><Check size={14} /> Saved</span> : "Save"}
                  </Button>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-white border-t border-gray-100 px-4 sm:px-8 py-4 flex gap-3 justify-end">
        ...
        <Button size="lg"><Briefcase size={16} /> Match Student</Button>
      </footer>
    </div>
  );
}