...
export default function NotFound() {
  ...
  // Send logged-in users back to their correct portal
  const handleGoHome = () => {
    ...
    <div className="min-h-screen w-full bg-brand-950 flex items-center justify-center p-4 font-body">
      <div className="w-full max-w-lg animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-1">
              <div className="flex items-baseline gap-3">
                <span className="font-display text-5xl font-black text-brand-900 leading-none">
                  404
                </span>
          ...
          {/* Show the attempted path so it's clear what went wrong */}
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            ...
            >
              <LogIn size={16} />
              {user ? "Go to My Portal" : "Return to Login"}
            </Button>
          </div>
