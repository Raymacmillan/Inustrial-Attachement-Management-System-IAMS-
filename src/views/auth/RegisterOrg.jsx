...
import {
  Building2, Mail, Lock, ArrowRight, MailCheck, AlertCircle,
} from "lucide-react";
...
export default function RegisterOrg() {
  ...
  // Derived — so the check is live as the user types, not only on submit
      ...
      <div className="min-h-screen w-full bg-brand-950 flex items-center justify-center p-4 font-body">
        <div className="max-w-md w-full bg-white p-10 rounded-3xl shadow-2xl border border-gray-100 text-center animate-in fade-in zoom-in-95 duration-500">
          ...
          <p className="text-gray-500 mb-8 leading-relaxed">
            ...
            <span className="font-bold text-brand-600">{email}</span>. Check your inbox to activate your employer account.
          </p>
          <Button onClick={() => navigate("/login")} fullWidth size="lg">Back to Login</Button>
        </div>
      </div>
    );
  }
        ...
        <div className="w-full lg:w-1/2 bg-white flex flex-col items-center justify-center p-8 sm:p-12">
          <div className="w-full max-w-md">
            <div className="mb-8 text-center lg:text-left">
              ...
              <p className="text-gray-500 font-medium">Register your organization with IAMS</p>
            </div>
